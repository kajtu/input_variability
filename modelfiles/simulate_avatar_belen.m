% simulate_avatar_belen.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_avatar_belen(tout,theta)
% [...] = simulate_avatar_belen(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_avatar_belen(...)
%
% INPUTS:
% =======
...
function varargout = simulate_avatar_belen(varargin)
...
if(max(options_ami.sens_ind)>23)
...
sol = ami_avatar_belen(tout,theta(1:23),kappa(1:19),options_ami,plist,xscale,init,data);
if(nargout>1)
